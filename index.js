...
1
// Questions
var nodes = [{ "node": 1, "message": "Ok, do you really like science?", "yes": 2, "no": 3 },
             { "node": 2, "message": "Okay, and do you like nature and things related with life?", "yes": 4, "no": 5 },
             { "node": 3, "message": "Nice, so do you like the idea of going to work every day with a nice suit?", "yes": 6, "no": 7 },
             { "node": 4, "message": "Perfect, and do you think you want to save lifes in the future?", "yes": 8, "no": 9 },
             { "node": 5, "message": "Great, and do you especially like technology?", "yes": 10, "no": 11 },
             { "node": 6, "message": "Okay, do you aspire to run your own business one day?", "yes": 12, "no": 13 },
             { "node": 7, "message": "Awesome, and do you like passing on your knowledge to other people?", "yes": 14, "no": 15 },

// Answers & descriptions
             { "node": 8, "message": "Nursing and Medicine", "yes": 0, "no": 0, "description": "As far as I can see from your answers, you are a person who cares about other people and want to make the world a better place saving lifes, because of that, the medics and nursery area would be a really good one for you." },
             { "node": 9, "message": "Biosciences", "yes": 0, "no": 0, "description": "Biosciences is an area of study that I thinyk you will enjoy, shaping the future of the health of the planet and mankind."},
             { "node": 10, "message": "IT and Computer Science", "yes": 0, "no": 0 , "description": "If you´re technologically minded Computer Science or IT are the areas to go, with great career prospects in today´s modern world."},
             { "node": 11, "message": "Maths or Physics", "yes": 0, "no": 0 , "description": "Pure Maths is a very demanding subject, as is physics, but for the right kind of mind they are very rewarding ones too."},
             { "node": 12, "message": "Business and Management Studies", "yes": 0, "no": 0 , "description": "Business and management studies are very general degrees, tied to no specific subject, but are very useful if you´re the kind of person who wants to get into big business."},
             { "node": 13, "message": "Law", "yes": 0, "no": 0 , "description": "Law is a very traditional subject that is very highly respected, I think it sounds just right for you."},
             { "node": 14, "message": "Education", "yes": 0, "no": 0 , "description": "Education is an extremely rewarding are of work and you sound like the right kind of person to pursue a career in that area."},
             { "node": 15, "message": "Psychology", "yes": 0, "no": 0 , "description": "The study of the mind. If you wonder what goes on in everybody else´s head every day, this degree can equip you with the tools to understand that."},
];
...
var welcomeMessage = "Welcome to The Degree Finder, I'm going to ask you a couple of simple questions and try my best to begin to narrow down to a degree you may enjoy. Are you ready to start?";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Say yes to start or no to quit.";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
var promptToStartMessage = "Say yes to continue, or no to finish.";

// This is the prompt during the game when Alexa doesnt hear or understand a yes / no reply
var promptToSayYesNo = "Say yes or no to answer the question.";

// This is the response to the user after the final question when Alex decides on what group choice the user should be given
var decisionMessage = "I think you should study";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Say 'tell me more' if you want me to tell you why I think you should study that, or tell me if you want to start again";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify what I think you should study. Want to start now?";
